...
class UIController:
    ...
    def _default_developer_prompt(self) -> str:
        return (
            ...
            "- Each setup must include setup_state: READY (actionable now/near-now) or WATCH (conditional but strategically useful). Prefer WATCH over NO_EDGE when a clear trigger/target/invalidation exists nearby.\n"
            "\n"
