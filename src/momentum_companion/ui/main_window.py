...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_layout(self) -> None:
        ...
        self.llm_reco.setWordWrap(True)
        self.llm_reco.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        status_left = QtWidgets.QVBoxLayout()
        ...
        status_left.addWidget(self.stream_label)
        status_left.addWidget(self.token_label)
        status_left.addWidget(self.last_update_label)
        status_right = QtWidgets.QVBoxLayout()
        status_right.setSpacing(2)
        self.connection_label = QtWidgets.QLabel("Connection: UNKNOWN")
        status_right.addWidget(self.connection_label)
        status_right.addStretch()
        status_layout.addLayout(status_left, 1)
