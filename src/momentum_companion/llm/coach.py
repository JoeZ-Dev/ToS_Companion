...
class LLMCoach:
    ...
    def __init__(self) -> None:
        ...
        self.system_prompt = (
            ...
            "- You MUST select setups only from candidate_setups provided in the payload. Copy entry/stop/target/target1_label exactly from the chosen candidate. Include candidate_index in each setup referencing its candidate. If none are acceptable, return stock_bias=NO_EDGE and setups=[]. You may only adjust narrative fields and rating.\n"
        )
